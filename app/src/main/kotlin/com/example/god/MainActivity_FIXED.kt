...
class MainActivity : ComponentActivity() {
    ...
    private fun showGodHome() {
        ...
        voiceRecognizedText?.setPadding(dp(4), 0, dp(4), 0)
        ...
        controls.addView(voiceButton, buttonWeight())

        val chatButton = createHudButton("CHAT")
        chatButton.setOnClickListener { showChatScreen() }
        controls.addView(chatButton, buttonWeight())

        val menuButton = createHudButton("MENU")
        menuButton.setOnClickListener { showSideMenu() }
        controls.addView(menuButton, buttonWeight())

        val bottom = TextView(this)
        bottom.text = "SYS  ●  ONLINE     CPU  --     RAM  --     BAT  --     NET  ●"
    ...
    private fun createPanel(): LinearLayout {
        ...
        panelLayout.setPadding(dp(12), dp(6), dp(12), dp(6))
    ...
    private fun updateVoiceMonitor(level: Float) {
        ...
        val bars = (clamped * 10f).toInt().coerceIn(0, 10)
        ...
        voiceMonitor?.text = "AUDIO  $waveform   MIC ACTIVE"
    }
    ...
    private fun showSideMenu() {
        ...
        menu.setPadding(dp(20), dp(18), dp(20), dp(20))
        ...
        backButton.setOnClickListener { showGodHome() }

        val backParams = LinearLayout.LayoutParams(
            ViewGroup.LayoutParams.MATCH_PARENT,
            dp(48)
        )
        backParams.setMargins(0, dp(18), 0, 0)

        menu.addView(backButton, backParams)
    ...
    private fun showChatScreen() {
        ...
        messageParams.setMargins(0, dp(20), 0, dp(10))
    ...
    override fun onRequestPermissionsResult(
        ...
        if (requestCode == microphonePermissionCode) {
            if (
                ...
                showMessage("Microphone permission is required for voice control.")
            }
        }
    }
            ...
            2002 -> {
                ...
                if (uri != null) {
                    try {
                        ...
                        showMessage("Authorized folder saved.")
                    } catch (_: Exception) {
                        showMessage("Folder selected.")
                    }
                }
            }
        }
