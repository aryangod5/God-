...
/**
 * GOD voice pipeline.
 * Uses the SpeechRecognizer RMS callback for microphone activity instead of opening
 * a second AudioRecord on the microphone, which can interfere with recognition on
    ...
    private fun createRecognizer() {
        ...
        recognizer?.setRecognitionListener(object : RecognitionListener {
            ...
            override fun onRmsChanged(rmsdB: Float) {
                // Smooth the recognizer's real RMS signal for the HUD.
            ...
            override fun onError(error: Int) {
                ...
                if (error == SpeechRecognizer.ERROR_NO_MATCH && !retryNoMatch) {
                    // ERROR_NO_MATCH (7) means the recognizer heard no usable match.
                    // Retry once rather than leaving the user stuck in ERROR.
                    retryNoMatch = true
                    listener.onStateChanged(AIState.LISTENING)
                    handler.postDelayed({
