...
class GodReferenceUi(
    ...
    private fun drawSecondaryPage(c: Canvas) {
        ...
        drawAngularPanel(
            c, width - dp(128f), dp(135f), width - dp(43f), dp(177f),
            orange, 0.9f, Color.argb(145, 5, 8, 12)
        )
        drawText(c, "BACK", width - dp(85f), dp(161f), 10f, white, true)
    ...
    override fun onTouchEvent(event: MotionEvent): Boolean {
        ...
        if (page != Page.HOME) {
            if ((x < dp(125f) && y < dp(115f)) ||
                (x >= width - dp(145f) && y >= dp(120f) && y <= dp(195f))) {
                page = Page.HOME
                menuVisible = true
